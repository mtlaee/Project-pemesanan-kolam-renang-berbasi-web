...
export class Kolam extends Component {
    constructor(){
        super();
        this.state={
            cari : '',
    ...
    componentDidMount(){
        fetch('http://localhost:8000/kolam')
            ...
            <div className='main'>
                <div className='container'>
                    <div style={{color:"#8B8B8B", display: "flex", flexDirection: "column", alignItems:"center", marginTop:'30px'}}>
                        ...
                        <div style={{width:350, fontSize:"18px", fontWeight: "bold", textAlign:"center"}}>Kami menawarkan lebih dari 100+ kolam berenang pilihan anda yang pastinya dengan kualitas terbaik.</div>
                    </div>
                    <div className='varian'>
                        <div className='text'>
                            ...
                            <div className='search-box2'>
                                ...
                                <input type="text" className='form-control search' onChange={this.getvalues_cari.bind(this)} placeholder="Cari Kolam Berenang Pilihan Anda"/>
                            </div>
                        </div>
...
export default withRouter(Kolam)
